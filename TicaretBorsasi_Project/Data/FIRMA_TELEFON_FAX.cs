...
namespace TicaretBorsasi_Project.Data
{
    ...
    public partial class FIRMA_TELEFON_FAX
    {
        public int FirmaTelefonFaxKey { get; set; }
        public Nullable<int> TuccarSicilKey { get; set; }
        public string FirmaTelefonFax { get; set; }
        ...
        public virtual TT_FIRMA_TELEFON_FAX_TIP TT_FIRMA_TELEFON_FAX_TIP { get; set; }
