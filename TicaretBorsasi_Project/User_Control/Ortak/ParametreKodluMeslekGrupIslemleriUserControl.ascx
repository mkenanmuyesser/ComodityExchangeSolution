<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ParametreKodluMeslekGrupIslemleriUserControl.ascx.cs" Inherits="TicaretBorsasi_Project.User_Control.Ortak.ParametreKodluMeslekGrupIslemleriUserControl" %>
...
<div style="margin: 1px; width: 99.9%;">
    <table style="border-color: #999999; width: 99.9%;" border="1">
        ...
        <tr>
            ...
            <td class="TdSolZorunlu" style="width: 15%;">
                <dx:ASPxLabel runat="server" Text="Meslek Adı : " Font-Size="Small" ForeColor="Red" />
            </td>
            <td class="TdSag" style="width: 35%;">
                <dx:ASPxTextBox ID="TextBoxMeslekAdi" runat="server" Width="200px" Font-Size="Small" MaxLength="50">
                    <ValidationSettings ValidationGroup="KayitGuncelle" Display="Dynamic">
                        <RequiredField ErrorText=" " IsRequired="true" />
                    </ValidationSettings>
                </dx:ASPxTextBox>
        ...
        <tr>
            <td class="TdOrtala" colspan="4">
                <dx:ASPxGridViewExporter ExportedRowType="All" GridViewID="GridViewMeslekGrup" ID="GridViewExporterMeslekGrup" runat="server">
                </dx:ASPxGridViewExporter>
                <dx:ASPxGridView ID="GridViewMeslekGrup" runat="server" KeyFieldName="MeslekGrupKey" AutoGenerateColumns="false" Width="100%" EnableCallBacks="true" Font-Size="Small" OnRowDeleting="GridViewMeslekGrup_RowDeleting" OnCustomButtonCallback="GridViewMeslekGrup_CustomButtonCallback">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataColumn FieldName="MeslekAdi" Caption="Meslek Adı">
                            <HeaderStyle HorizontalAlign="Center" />
                        </dx:GridViewDataColumn>
