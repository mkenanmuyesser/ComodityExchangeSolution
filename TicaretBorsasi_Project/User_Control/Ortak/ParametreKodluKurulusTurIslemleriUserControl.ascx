<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ParametreKodluKurulusTurIslemleriUserControl.ascx.cs" Inherits="TicaretBorsasi_Project.User_Control.Ortak.ParametreKodluKurulusTurIslemleriUserControl" %>
...
<div style="margin: 1px; width: 99.9%;">
    <table style="border-color: #999999; width: 99.9%;" border="1">
        ...
        <tr>
            ...
            <td class="TdSag" style="width: 35%;">
                <dx:ASPxTextBox ID="TextBoxTobbKodu" runat="server" Width="200px" Font-Size="Small" MaxLength="2">
        ...
        <tr>
            <td class="TdSolZorunlu" style="width: 15%;">
                <dx:ASPxLabel runat="server" Text="Kuruluş Türü Adı : " Font-Size="Small" ForeColor="Red" />
            </td>
            <td class="TdSag" style="width: 35%;">
                <dx:ASPxTextBox ID="TextBoxKurulusTuruAdi" runat="server" Width="200px" Font-Size="Small" MaxLength="50">
                    <ValidationSettings ValidationGroup="KayitGuncelle" Display="Dynamic">
                        <RequiredField ErrorText=" " IsRequired="true" />
                    </ValidationSettings>
                </dx:ASPxTextBox>
        ...
        <tr>
            <td class="TdOrtala" colspan="4">
                <dx:ASPxGridViewExporter ExportedRowType="All" GridViewID="GridViewKurulusTur" ID="GridViewExporterKurulusTur" runat="server">
                </dx:ASPxGridViewExporter>
                <dx:ASPxGridView ID="GridViewKurulusTur" runat="server" KeyFieldName="KurulusTurKey" AutoGenerateColumns="false" Width="100%" EnableCallBacks="true" Font-Size="Small" OnRowDeleting="GridViewKurulusTur_RowDeleting" OnCustomButtonCallback="GridViewKurulusTur_CustomButtonCallback">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataColumn FieldName="Adi" Caption="Kuruluş Türü Adı">
                            <HeaderStyle HorizontalAlign="Center" />
                        </dx:GridViewDataColumn>
