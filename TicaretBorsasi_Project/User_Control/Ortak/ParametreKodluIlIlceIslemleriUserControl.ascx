<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ParametreKodluIlIlceIslemleriUserControl.ascx.cs" Inherits="TicaretBorsasi_Project.User_Control.Ortak.ParametreKodluIlIlceIslemleriUserControl" %>
...
<div style="margin: 1px; width: 99.9%;">
    <table style="border-color: #999999; width: 99.9%;" border="1">
        ...
        <tr>
            ...
            <td class="TdSag" style="width: 35%;">
                <dx:ASPxTextBox ID="TextBoxTobbKodu" runat="server" Width="200px" Font-Size="Small" MaxLength="5">
        ...
        <tr>
            <td class="TdSolZorunlu" style="width: 15%;">
                <dx:ASPxLabel runat="server" Text="İl İlçe Adı : " Font-Size="Small" ForeColor="Red" />
            </td>
            <td class="TdSag" style="width: 35%;">
                <dx:ASPxTextBox ID="TextBoxIlIlceAd" runat="server" Width="200px" Font-Size="Small" MaxLength="50">
                    <ValidationSettings ValidationGroup="KayitGuncelle" Display="Dynamic">
                        <RequiredField ErrorText=" " IsRequired="true" />
                    </ValidationSettings>
                </dx:ASPxTextBox>
        ...
        <tr>
            <td class="TdOrtala" colspan="4">
                <dx:ASPxGridViewExporter ExportedRowType="All" GridViewID="GridViewIlIlce" ID="GridViewExporterIlIlce" runat="server">
                </dx:ASPxGridViewExporter>
                <dx:ASPxGridView ID="GridViewIlIlce" runat="server" KeyFieldName="IlIlceKey" AutoGenerateColumns="false" Width="100%" EnableCallBacks="true" Font-Size="Small" OnRowDeleting="GridViewIlIlce_RowDeleting" OnCustomButtonCallback="GridViewIlIlce_CustomButtonCallback">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataColumn FieldName="IlIlceAdi" Caption="İl İlçe Adı">
                            <HeaderStyle HorizontalAlign="Center" />
                        </dx:GridViewDataColumn>
