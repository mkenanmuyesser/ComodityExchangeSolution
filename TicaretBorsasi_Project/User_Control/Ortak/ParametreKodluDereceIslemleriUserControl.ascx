<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ParametreKodluDereceIslemleriUserControl.ascx.cs" Inherits="TicaretBorsasi_Project.User_Control.Ortak.ParametreKodluDereceIslemleriUserControl" %>
...
<div style="margin: 1px; width: 99.9%;">
    <table style="border-color: #999999; width: 99.9%;" border="1">
        ...
        <tr>
            ...
            <td class="TdSolZorunlu" style="width: 15%;">
                <dx:ASPxLabel runat="server" Text="Muhasebe Kodu : " Font-Size="Small" ForeColor="Red" />
            </td>
            <td class="TdSag" style="width: 35%;">
                <dx:ASPxTextBox ID="TextBoxMuhasebeKodu" runat="server" Width="200px" Font-Size="Small" MaxLength="5">
        ...
        <tr>
            <td class="TdSolZorunlu" style="width: 15%;">
                <dx:ASPxLabel runat="server" Text="Kaydiye : " Font-Size="Small" ForeColor="Red" />
            </td>
            <td class="TdSag" style="width: 35%;">
                <dx:ASPxSpinEdit ID="SpinEditKaydiye" runat="server" DecimalPlaces="2" Width="200px" Font-Size="Small" MaxLength="11" NumberType="Float" AllowNull="false" MinValue="0" SpinButtons-ShowIncrementButtons="false">
                    <ValidationSettings ValidationGroup="KayitGuncelle" Display="Dynamic">
                        <RequiredField ErrorText=" " IsRequired="true" />
                    </ValidationSettings>
                </dx:ASPxSpinEdit>
            ...
            <td class="TdSolZorunlu" style="width: 15%;">
                <dx:ASPxLabel runat="server" Text="Aidat : " Font-Size="Small" ForeColor="Red" />
            </td>
            <td class="TdSag" style="width: 35%;">
                <dx:ASPxSpinEdit ID="SpinEditAidat" runat="server" DecimalPlaces="2" Width="200px" Font-Size="Small" MaxLength="11" NumberType="Float" AllowNull="false" MinValue="0" SpinButtons-ShowIncrementButtons="false">
                    <ValidationSettings ValidationGroup="KayitGuncelle" Display="Dynamic">
                        <RequiredField ErrorText=" " IsRequired="true" />
                    </ValidationSettings>
                </dx:ASPxSpinEdit>
        ...
        <tr>
            <td class="TdOrtala" colspan="4">
                <dx:ASPxGridViewExporter ExportedRowType="All" GridViewID="GridViewDerece" ID="GridViewExporterDerece" runat="server">
                </dx:ASPxGridViewExporter>
                <dx:ASPxGridView ID="GridViewDerece" runat="server" KeyFieldName="DereceKey" AutoGenerateColumns="false" Width="100%" EnableCallBacks="true" Font-Size="Small" OnRowDeleting="GridViewDerece_RowDeleting" OnCustomButtonCallback="GridViewDerece_CustomButtonCallback">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataColumn FieldName="Kaydiye" Caption="Kaydiye">
                              <CellStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="Aidat" Caption="Aidat">
                            <CellStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="MuhasebeKodu" Caption="Muhasebe Kodu">
                            <CellStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        </dx:GridViewDataColumn>
