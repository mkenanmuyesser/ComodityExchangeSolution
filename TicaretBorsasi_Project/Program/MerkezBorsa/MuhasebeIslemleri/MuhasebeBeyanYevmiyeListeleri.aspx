<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page/Main.master" AutoEventWireup="true" CodeBehind="MuhasebeBeyanYevmiyeListeleri.aspx.cs" Inherits="TicaretBorsasi_Project.Program.MerkezBorsa.MuhasebeIslemleri.MuhasebeBeyanYevmiyeListeleri" %>
    ...
    <div style="margin: 1px; width: 99.9%;">
        <table style="border-color: #999999; width: 99.9%;" border="1">
            ...
            <tr>
                ...
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxComboBox ID="ComboBoxSatisSekli" runat="server" ValueType="System.String" Width="200px" Font-Size="Small" TextField="" ValueField="" Enabled="false">
                    </dx:ASPxComboBox>
                </td>
            ...
            <tr>
                <td class="TdOrtala" colspan="4">
                    ...
                    <dx:ASPxGridView ID="GridViewBeyanYevmiye" ClientInstanceName="GridViewBeyanYevmiye" runat="server" KeyFieldName="BeyanKey" AutoGenerateColumns="false" Width="100%" Font-Size="Small">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn FieldName="" Caption="Sat. Org. Hz.">
                                <CellStyle HorizontalAlign="Center" />
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="" Caption="Tescil Ücreti">
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
                        </Columns>
                        <%-- <TotalSummary>
