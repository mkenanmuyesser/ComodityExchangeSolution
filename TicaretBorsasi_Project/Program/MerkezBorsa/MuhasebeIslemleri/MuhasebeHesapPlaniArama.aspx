<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page/Main.master" AutoEventWireup="true" CodeBehind="MuhasebeHesapPlaniArama.aspx.cs" Inherits="TicaretBorsasi_Project.Program.MerkezBorsa.MuhasebeIslemleri.MuhasebeHesapPlaniArama" %>
        ...
        <table style="border-color: #999999; width: 99.9%;" border="1">
            ...
            <tr>
                <td class="TdOrtala" colspan="4">
                    ...
                    <dx:ASPxGridView ID="GridViewHesapPlani" ClientInstanceName="GridViewHesapPlani" runat="server" KeyFieldName="HesapPlaniKey" AutoGenerateColumns="false" Width="100%" Font-Size="Small" OnRowDeleting="GridViewHesapPlani_RowDeleting" OnCustomButtonCallback="GridViewHesapPlani_CustomButtonCallback">
