...
{
    public partial class MuhasebeListeGunlukGirisCikislar : Page
    {
        #region Properties
        ...
        {
            LabelBaslik.Text = "GÜNLÜK GİRİŞ/ÇIKIŞLAR";
        ...
        private void Ara()
        {
            using (var entity = new DBEntities())
            {
                ...
                var sonuc = entity.YEVMIYEs.Include("HESAP_PLANI").Include("TT_FIS_TIP").AsNoTracking()
                           .ToList()
                           .Where(
                            p =>
                ...
                GridViewYardimciDefter.ExpandAll();
            }
        }
