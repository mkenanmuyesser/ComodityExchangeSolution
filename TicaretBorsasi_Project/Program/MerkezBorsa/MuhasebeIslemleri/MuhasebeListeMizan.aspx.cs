...
{
    public partial class MuhasebeListeMizan : Page
    {
        #region Properties
        ...
        protected void ButtonRapor_Click(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    GridViewExporterMizan.WriteXlsxToResponse("Mizan");
                    break;
                case 1:
                    GridViewExporterMizan.WritePdfToResponse("Mizan");
                    break;
                default:
                    break;
            }
