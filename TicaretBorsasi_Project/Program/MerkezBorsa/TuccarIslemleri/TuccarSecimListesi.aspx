<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page/Main.master" AutoEventWireup="true" CodeBehind="TuccarSecimListesi.aspx.cs" Inherits="TicaretBorsasi_Project.Program.MerkezBorsa.TuccarIslemleri.TuccarSecimListesi" %>
        ...
        <table style="border-color: #999999; width: 99.9%;" border="1">
            ...
            <tr>
                <td class="TdSol" style="width: 15%">
                    <dx:ASPxLabel runat="server" Text="Seçim Tarihi : " Font-Size="Small" />
                </td>
                <td class="TdSag" style="width: 35%">
                    <dx:ASPxDateEdit ID="DateEditSecimTarihi" runat="server" Font-Size="Small" Width="200">
                ...
                <td class="TdSol" style="width: 15%">
                    <dx:ASPxLabel runat="server" Text="Döküm Tipi : " Font-Size="Small" />
                </td>
                <td class="TdSag" style="width: 35%">
                    <dx:ASPxComboBox ID="ComboBoxDokumTipi" runat="server" ValueType="System.String" Width="200px" Font-Size="Small">
                        <Items>
                            <dx:ListEditItem Selected="true" Text="Sadece Seçme" Value="1" />
                            <dx:ListEditItem Text="Seçme ve Seçilme" Value="2" />
                        </Items>
                    </dx:ASPxComboBox>
                </td>
            </tr>
            ...
            <tr>
                <td class="TdOrtala" colspan="4">
                    <dx:ASPxGridViewExporter ExportedRowType="All" GridViewID="GridViewTuccarSecimListesi" ID="GridViewExporterTuccarSecimListesi" runat="server">
                    </dx:ASPxGridViewExporter>
                    <dx:ASPxGridView ID="GridViewTuccarSecimListesi" ClientInstanceName="GridViewTicaretSicilMemurluğuListesi" runat="server" KeyFieldName="TuccarSicilKey" AutoGenerateColumns="false" Width="100%" Font-Size="Small">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn FieldName="Unvan" Caption="Unvan/Adı Soyadı">
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="VergiDairesiAdi" Caption="Vergi Dairesi">
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
                        </Columns>
                    </dx:ASPxGridView>
