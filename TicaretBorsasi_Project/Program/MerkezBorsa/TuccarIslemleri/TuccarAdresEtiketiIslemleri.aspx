<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page/Main.master" AutoEventWireup="true" CodeBehind="TuccarAdresEtiketiIslemleri.aspx.cs" Inherits="TicaretBorsasi_Project.Program.MerkezBorsa.TuccarIslemleri.TuccarAdresEtiketiIslemleri" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMiddleContent" runat="server">
    <dx:ASPxPopupControl runat="server" ID="PopupControlRapor" ClientInstanceName="PopupControlRapor" CloseAction="CloseButton" AppearAfter="100" DisappearAfter="100" HeaderText=" ">
    </dx:ASPxPopupControl>
    <div style="margin: 1px; width: 99.9%;">
        <table style="border-color: #999999; width: 99.9%;" border="1">
            ...
            <tr>
                ...
                <td class="TdSag">
                    <table style="width: 400px;">
                        <tr>
                            <td>
                                <dx:ASPxSpinEdit ID="SpinEditMeslekGrupBaslangic" runat="server" DecimalPlaces="2" Width="200px" Font-Size="Small" MaxLength="6" NumberType="Integer" AllowNull="true" MinValue="0" SpinButtons-ShowIncrementButtons="false">
                                </dx:ASPxSpinEdit>
                            </td>
                            <td style="padding-left: 5px;">
                                <dx:ASPxSpinEdit ID="SpinEditMeslekGrupBitis" runat="server" DecimalPlaces="2" Width="200px" Font-Size="Small" MaxLength="6" NumberType="Integer" AllowNull="true" MinValue="0" SpinButtons-ShowIncrementButtons="false">
                                </dx:ASPxSpinEdit>
                            </td>
                        </tr>
                    </table>
                ...
                <td class="TdSolZorunlu" style="width: 15%">
                    <dx:ASPxLabel runat="server" Text="Terkin Durumu : " Font-Size="Small" ForeColor="Red" />
                </td>
                <td class="TdSag">
            ...
            <tr>
                ...
                <td class="TdSag">
                    <dx:ASPxComboBox ID="ComboBoxDokumTipi" runat="server" ValueType="System.String" Width="200px" Font-Size="Small">
                        <Items>
                            <dx:ListEditItem Text="Gerçek" Value="1" Selected="true" />
                            <dx:ListEditItem Text="Tüzel" Value="2" />
                        </Items>
                    </dx:ASPxComboBox>
                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <dx:ASPxComboBox ID="ComboBoxSirala" runat="server" Font-Size="Small" Width="115">
                                        <Items>
                                            <dx:ListEditItem Selected="true" Text="Unvan" Value="1" />
                                            <dx:ListEditItem Text="Sicil No" Value="2" />
                                        </Items>
                                    </dx:ASPxComboBox>
                                </td>
                                <td>
            ...
            <tr>
                <td class="TdOrtala" colspan="2" style="width: 50%">
                    <dx:ASPxGridView ID="GridViewAdresEtiketAra" ClientInstanceName="GridViewAdresEtiketAra" runat="server" KeyFieldName="TuccarSicilKey" AutoGenerateColumns="false" Width="100%" Font-Size="Small" OnRowCommand="GridViewAdresEtiketAra_RowCommand">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn FieldName="Unvan" Caption="Üye Adı/Unvan">
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn Caption="İşlemler">
                                <DataItemTemplate>
                                    <dx:ASPxButton ID="ButtonAdresListeEkle" runat="server" Image-Url="../../../Content/Images/Icons/send.png" Image-Height="24" Image-Width="24" RenderMode="Link" CommandArgument='<%# Eval("TuccarSicilKey") %>'></dx:ASPxButton>
                                </DataItemTemplate>
                                <CellStyle HorizontalAlign="Center" />
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
                ...
                <td class="TdOrtala" colspan="2" style="vertical-align: top;">
                    <dx:ASPxGridViewExporter ExportedRowType="All" GridViewID="GridViewAdresEtiketBasilacak" ID="GridViewExporterAdresEtiketBasilacak" runat="server">
                    </dx:ASPxGridViewExporter>
                    <dx:ASPxGridView ID="GridViewAdresEtiketBasilacak" ClientInstanceName="GridViewAdresEtiketBasilacak" runat="server" KeyFieldName="TuccarSicilKey" AutoGenerateColumns="false" Width="100%" Font-Size="Small" OnRowCommand="GridViewAdresEtiketBasilacak_RowCommand">
                        <Settings ShowGroupPanel="false" />
                        <SettingsText ConfirmDelete="Silme işlemini onaylıyor musunuz?" />
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn Caption="İşlemler">
                                <DataItemTemplate>
                                    <dx:ASPxButton ID="ButtonAdresListeKaldir" runat="server" Image-Url="../../../Content/Images/Icons/back.png" Image-Height="24" Image-Width="24" RenderMode="Link" CommandArgument='<%# Eval("TuccarSicilKey") %>'></dx:ASPxButton>
                                </DataItemTemplate>
                                <CellStyle HorizontalAlign="Center" />
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
                    ...
                    <table style="border-color: #999999; width: 100%;" border="1">
                        <tr>
                            <td class="TdOrtala">
                                <div style="float: left; margin-left: 25%;">
                                    <dx:ASPxButton ID="ButtonListeYazdir" runat="server" Text="Listedeki Adresleri Yazdır" Width="120" Font-Size="Small" OnClick="ButtonListeYazdir_Click" />
                                    <dx:ASPxButton ID="ButtonSecimliListeYazdir" runat="server" Text="Seçimli Listedeki Adresleri Yazdır" Width="120" Font-Size="Small" OnClick="ButtonSecimliListeYazdir_Click" Enabled="false" />
                                </div>
                            </td>
                        </tr>
                    </table>
