<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page/Main.master" AutoEventWireup="true" CodeBehind="BeyannameBeyanYevmiyeListeleri.aspx.cs" Inherits="TicaretBorsasi_Project.Program.MerkezBorsa.BeyannameTescilIslemleri.BeyannameBeyanYevmiyeListeleri" %>
    ...
    <div style="margin: 1px; width: 99.9%;">
        <table style="border-color: #999999; width: 99.9%;" border="1">
            ...
            <tr>
                ...
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxComboBox ID="ComboBoxListeTipi" runat="server" ValueType="System.String" Width="200px" Font-Size="Small" AutoPostBack="true" OnSelectedIndexChanged="ComboBoxListeTipi_SelectedIndexChanged">
                        <Items>
                            <dx:ListEditItem Text="Peşin" Value="1" />
                            <dx:ListEditItem Text="Tahakkuk" Value="2" />
                            <dx:ListEditItem Text="Tümü" Value="3" />
                        </Items>
                ...
                <td class="TdSol" style="width: 15%;">
                    <dx:ASPxLabel runat="server" Text="Muhasebe Adı : " Font-Size="Small" />
                </td>
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxComboBox ID="ComboBoxMuhasebeTip" runat="server" ValueType="System.String" Width="200px" Font-Size="Small" TextField="Adi" ValueField="MuhasebeTipKey" Enabled="false">
                        <ValidationSettings ValidationGroup="Ara" Display="Dynamic">
                            <RequiredField ErrorText=" " IsRequired="true" />
                        </ValidationSettings>
                    </dx:ASPxComboBox>
            ...
            <tr>
                ...
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxSpinEdit ID="SpinEditBaslangicSubeKodu" runat="server" DecimalPlaces="2" Width="200px" Font-Size="Small" MaxLength="2" NumberType="Integer" AllowNull="true" MinValue="0" SpinButtons-ShowIncrementButtons="false" Enabled="false">
                    </dx:ASPxSpinEdit>
                </td>
                <td class="TdSol" style="width: 15%;">
                ...
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxSpinEdit ID="SpinEditBitisSubeKodu" runat="server" DecimalPlaces="2" Width="200px" Font-Size="Small" MaxLength="2" NumberType="Integer" AllowNull="true" MinValue="0" SpinButtons-ShowIncrementButtons="false" Enabled="false">
                    </dx:ASPxSpinEdit>
                </td>
            </tr>
            <tr>
                <td class="TdSol" style="width: 15%;">
                    <dx:ASPxLabel runat="server" Text="Satış Şekli : " Font-Size="Small" />
                </td>
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxComboBox ID="ComboBoxSatisSekli" runat="server" ValueType="System.String" Width="200px" Font-Size="Small" TextField="SatisSekliAdi" ValueField="SatisSekliKey" Enabled="false">
                    </dx:ASPxComboBox>
                </td>
                                ...
                                <td>
                                    <dx:ASPxComboBox ID="ComboBoxSirala" runat="server" Font-Size="Small" Width="115">
                                        <Items>
                                            ...
                                            <dx:ListEditItem Text="Beyan" Value="3" />
                                        </Items>
                                    </dx:ASPxComboBox>
                                </td>
                                <td>
            ...
            <tr>
                <td class="TdOrtala" colspan="4">
                    <dx:ASPxGridViewExporter ExportedRowType="All" GridViewID="GridViewBeyanYevmiye" ID="GridViewExporterBeyanYevmiye" runat="server">
                    </dx:ASPxGridViewExporter>
                    <dx:ASPxGridView ID="GridViewBeyanYevmiye" ClientInstanceName="GridViewBeyanYevmiye" runat="server" KeyFieldName="Sira" AutoGenerateColumns="false" Width="100%" Font-Size="Small" >
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn FieldName="SicilNo" Caption="SicilNo" CellStyle-HorizontalAlign="Right">
                                <HeaderStyle HorizontalAlign="Center" />                                
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="Unvan" Caption="Unvan">
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="SatOrgH" Caption="Sat. Org. Hz." CellStyle-HorizontalAlign="Right">
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="Tescil" Caption="Tescil Ücreti" CellStyle-HorizontalAlign="Right">
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
                        </Columns>
                        <TotalSummary>
                            <dx:ASPxSummaryItem FieldName="SatOrgH" SummaryType="Sum" />
                            <dx:ASPxSummaryItem FieldName="Tescil" SummaryType="Sum" />
                        </TotalSummary>
                    </dx:ASPxGridView>
                </td>
            </tr>
