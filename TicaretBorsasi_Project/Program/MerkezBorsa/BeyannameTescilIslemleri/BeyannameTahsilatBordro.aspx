<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page/Main.master" AutoEventWireup="true" CodeBehind="BeyannameTahsilatBordro.aspx.cs" Inherits="TicaretBorsasi_Project.Program.MerkezBorsa.BeyannameTescilIslemleri.BeyannameTahsilatBordro" %>
        ...
        <table style="border-color: #999999; width: 99.9%;" border="1">
            ...
            <tr>
                <td class="TdOrtala" colspan="4">
                    ...
                    <dx:ASPxGridView ID="GridViewTahsilatBordro" ClientInstanceName="GridViewTahsilatBordro" runat="server" KeyFieldName="HesapPlaniKey" AutoGenerateColumns="false" Width="100%" Font-Size="Small">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn FieldName="Tutar" Caption="Tutarı">
                                <CellStyle HorizontalAlign="Center" />
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
                        </Columns>
