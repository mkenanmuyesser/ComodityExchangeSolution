...
{
    public partial class GidenEvrakIslemleri : Page
    {
        #region Properties
        ...
        {
            LabelBaslik.Text = "GİDEN EVRAK İŞLEMLERİ";
        ...
        private void DataLoad()
        {
            using (var entity = new DBEntities())
            {
                ...
                if (Key != 0 && !IsPostBack)
                {
                    GELEN_GIDEN_EVRAK data = entity.GELEN_GIDEN_EVRAK.Single(p => p.GelenGidenEvrakKey == Key);
