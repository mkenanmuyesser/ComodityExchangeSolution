<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page/Main.master" AutoEventWireup="true" CodeBehind="YazismaAdresleri.aspx.cs" Inherits="TicaretBorsasi_Project.Program.MerkezBorsa.MuhtelifIslemler.YazismaAdresleri" %>
    ...
    <div style="margin: 1px; width: 99.9%;">
        <table style="border-color: #999999; width: 99.9%;" border="1">
            ...
            <tr>
                ...
                <td class="TdSolZorunlu" style="width: 15%;">
                    <dx:ASPxLabel runat="server" Text="Yazışma Adresi : " Font-Size="Small" ForeColor="Red" />
                </td>
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxTextBox ID="TextBoxYazismaAdres" runat="server" Width="200px" Font-Size="Small" MaxLength="50">
                        <ValidationSettings ValidationGroup="KayitGuncelle" Display="Dynamic">
                            <RequiredField ErrorText=" " IsRequired="true" />
                        </ValidationSettings>
                    </dx:ASPxTextBox>
            ...
            <tr>
                <td class="TdOrtala" colspan="4">
                    <dx:ASPxGridViewExporter ExportedRowType="All" GridViewID="GridViewYazismaAdres" ID="GridViewExporterYazismaAdres" runat="server">
                    </dx:ASPxGridViewExporter>
                    <dx:ASPxGridView ID="GridViewYazismaAdres" runat="server" KeyFieldName="YazismaAdresKey" AutoGenerateColumns="false" Width="100%" EnableCallBacks="true" Font-Size="Small" OnRowDeleting="GridViewYazismaAdres_RowDeleting" OnCustomButtonCallback="GridViewYazismaAdres_CustomButtonCallback">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn FieldName="YazismaAdresAdi" Caption="Yazışma Adresi">
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="" Caption="Kayıt Sayısı">
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
