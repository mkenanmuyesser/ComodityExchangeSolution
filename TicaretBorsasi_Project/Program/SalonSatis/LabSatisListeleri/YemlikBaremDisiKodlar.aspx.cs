...
{
    public partial class YemlikBaremDisiKodlar : Page
    {
        #region Properties
        ...
        protected void ButtonRapor_Click(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    GridViewExporterYemlikBaremDisiKodlar.WriteXlsxToResponse("Yemlik veya Barem Dışı Kodlar");
                    break;
                case 1:
                    GridViewExporterYemlikBaremDisiKodlar.WritePdfToResponse("Yemlik veya Barem Dışı Kodlar");
                    break;
                default:
                    break;
            }
        ...
        protected void ButtonKantarTartimGuncelle_Click(object sender, EventArgs e)
        {

        }

        protected void ButtonKantarTartimIptal_Click(object sender, EventArgs e)
        {
        ...
        protected void ButtonKaydetGuncelle_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("YemlikBaremDisiKodlar.aspx");
        }
        ...
        protected void GridViewYemlikBaremDisiKodlar_RowDeleting(object sender, ASPxDataDeletingEventArgs e)
        {
            using (var entity = new DBEntities())
            {
                ...
                try
                {
                    if (Key != 0)
                    {
                        GridViewYemlikBaremDisiKodlar.JSProperties["cpErrorMessage"] = true;
                    }
                    else
                    {
                        entity.SaveChanges();GridViewYemlikBaremDisiKodlar.JSProperties["cpErrorMessage"] = false;
                    }
                }
                catch
                {
        ...
        protected void GridViewYemlikBaremDisiKodlar_CustomButtonCallback(object sender, ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            int index = e.VisibleIndex;
            int key = Convert.ToInt32(GridViewYemlikBaremDisiKodlar.GetRowValues(index, new[] { "BorsaSubeKey" }));
            ASPxWebControl.RedirectOnCallback(string.Format("YemlikBaremDisiKodlar.aspx?Key={0}", key));
        }
        ...
        private void SetInitials()
        {
            ...
            LabelBaslik.Text = "YEMLİK veya BAREM DIŞI KODLAR";
        }
        ...
        private void DataLoad()
        {
            using (var entity = new DBEntities())
            {
                ...
                GridViewYemlikBaremDisiKodlar.DataSource = null;
                GridViewYemlikBaremDisiKodlar.DataSource = entity.TT_BORSA_SUBE.AsNoTracking().Select(p => new
                {
                    p.BorsaSubeKey,
                    p.Kod,
                    p.BorsaSubeAdi,
                ...
                GridViewYemlikBaremDisiKodlar.DataBind();
