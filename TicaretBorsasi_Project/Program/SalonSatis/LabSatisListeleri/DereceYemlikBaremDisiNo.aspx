<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page/Main.master" AutoEventWireup="true" CodeBehind="DereceYemlikBaremDisiNo.aspx.cs" Inherits="TicaretBorsasi_Project.Program.SalonSatis.LabSatisListeleri.DereceYemlikBaremDisiNo" %>
        ...
        <table style="border-color: #999999; width: 99.9%;" border="1">
            ...
            <tr>
                ...
                <td class="TdSag" style="width: 35%;">
                   <dx:ASPxTextBox ID="TextBoxGrupNo" runat="server" Width="200px" Font-Size="Small" MaxLength="3">
              ...
              <td class="TdSolZorunlu" style="width: 15%;">
                    <dx:ASPxLabel  runat="server" Text="Grup Adı : " Font-Size="Small" ForeColor="Red" />
                </td>
                <td class="TdSag" style="width: 35%;">
                   <dx:ASPxTextBox ID="TextBoxGrupAdi" runat="server" Width="200px" Font-Size="Small" MaxLength="50">
                        <ValidationSettings ValidationGroup="KayitGuncelle" Display="Dynamic">
                            <RequiredField ErrorText=" " IsRequired="True" />
                        </ValidationSettings>
                    </dx:ASPxTextBox>
            ...
            <tr>
                <td class="TdSol" style="width: 15%;">
                    <dx:ASPxLabel runat="server" Text="Yemlik Sr. No : " Font-Size="Small" />
                </td>
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxTextBox ID="TextBoxYemlikSrNo" runat="server" Width="200px" Font-Size="Small" MaxLength="3">
                        <MaskSettings Mask="999" />
                    </dx:ASPxTextBox>
                </td>
                <td class="TdSol" style="width: 15%;">
                    <dx:ASPxLabel runat="server" Text="Barem Dışı Sr. No : " Font-Size="Small" />
                </td>
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxTextBox ID="TextBoxNaremDisiSrNo" runat="server" Width="200px" Font-Size="Small" MaxLength="3">
                        <MaskSettings Mask="999" />
                    </dx:ASPxTextBox>
                </td>
            </tr>
            ...
            <tr>
                <td class="TdOrtala" colspan="4">
                    <dx:ASPxGridViewExporter ExportedRowType="All" GridViewID="GridViewDereceYemlikBaremDisiNo" ID="GridViewExporterDereceYemlikBaremDisiNo" runat="server">
                    </dx:ASPxGridViewExporter>
                    <dx:ASPxGridView ID="GridViewDereceYemlikBaremDisiNo" runat="server" KeyFieldName="BorsaSubeKey" AutoGenerateColumns="false" Width="100%" EnableCallBacks="true" Font-Size="Small" OnRowDeleting="GridViewDereceYemlikBaremDisiNo_RowDeleting" OnCustomButtonCallback="GridViewDereceYemlikBaremDisiNo_CustomButtonCallback">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn FieldName="" Caption="Grup Adı">
                                <CellStyle HorizontalAlign="Center" />
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="" Caption="Derece/Grup veya Sınıf Sayısı">
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="" Caption="Yemlik Sr. No">
                                <CellStyle HorizontalAlign="Center" />
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="" Caption="Barem Dışı Sr. No">
                                <CellStyle HorizontalAlign="Center" />
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
