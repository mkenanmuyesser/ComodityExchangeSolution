...
{
    public partial class TartiUcretleri : Page
    {
        #region Properties
        ...
        protected void ButtonRapor_Click(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    GridViewExporterTartiUcretleri.WriteXlsxToResponse("Tartı Ucretleri");
                    break;
                case 1:
                    GridViewExporterTartiUcretleri.WritePdfToResponse("Tartı Ucretleri");
                    break;
                default:
                    break;
            }
        ...
        protected void GridViewTartiUcretleri_RowDeleting(object sender, ASPxDataDeletingEventArgs e)
        {
            using (var entity = new DBEntities())
            {
                ...
                try
                {
                    if (Key != 0)
                    {
                        GridViewTartiUcretleri.JSProperties["cpErrorMessage"] = true;
                    }
                    else
                    {
                        entity.SaveChanges();
                        GridViewTartiUcretleri.JSProperties["cpErrorMessage"] = false;
                    }
                }
                catch
                {
        ...
        protected void GridViewTartiUcretleri_CustomButtonCallback(object sender, ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            int index = e.VisibleIndex;
            int key = Convert.ToInt32(GridViewTartiUcretleri.GetRowValues(index, new[] { "BorsaSubeKey" }));
            ASPxWebControl.RedirectOnCallback(string.Format("TartiUcretleri.aspx?Key={0}",  key));
        }
        ...
        private void SetInitials()
        {
            ...
            LabelBaslik.Text = "TARTI ÜCRETLERİ";
        }
        ...
        private void DataLoad()
        {
            using (var entity = new DBEntities())
            {
                ...
                GridViewTartiUcretleri.DataSource = null;
                GridViewTartiUcretleri.DataSource = entity.TT_BORSA_SUBE.AsNoTracking().Select(p => new
                {
                    p.BorsaSubeKey,
                    p.Kod,
                    p.BorsaSubeAdi,
                ...
                GridViewTartiUcretleri.DataBind();
