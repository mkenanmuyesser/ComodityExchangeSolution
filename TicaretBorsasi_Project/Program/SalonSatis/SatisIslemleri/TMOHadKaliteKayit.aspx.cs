...
{
    public partial class TMOHadKaliteKayit : Page
    {
        #region Properties
        ...
        {
            Response.Redirect("TMOHadKaliteKayit.aspx");
        }
        ...
        private void SetInitials()
        {
            if (TuccarDepoKey == 0)
            {
                LabelBaslik.Text = "TMO HAD ve KALİTE KAYDET";
            ...
            {
                LabelBaslik.Text = "TMO HAD ve KALİTE GÜNCELLE";
