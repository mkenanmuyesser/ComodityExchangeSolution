...
{
    public partial class TMOAnalizIlaveAciklamalari : Page
    {
        #region Properties
        ...
        protected void ButtonRapor_Click(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    GridViewExporterTMOAnalizIlaveAciklamalari.WriteXlsxToResponse("TMO Analiz İlave Açıklamaları");
                    break;
                case 1:
                    GridViewExporterTMOAnalizIlaveAciklamalari.WritePdfToResponse("TMO Analiz İlave Açıklamaları");
                    break;
                default:
                    break;
            }
        ...
        protected void ButtonKaydetGuncelle_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("TMOAnalizIlaveAciklamalari.aspx");
        }
        ...
        protected void GridViewTMOAnalizIlaveAciklamalari_RowDeleting(object sender, ASPxDataDeletingEventArgs e)
        {
            using (var entity = new DBEntities())
            {
                ...
                try
                {
                    if (Key != 0)
                    {
                        GridViewTMOAnalizIlaveAciklamalari.JSProperties["cpErrorMessage"] = true;
                    }
                    else
                    {
                        entity.SaveChanges();
                        GridViewTMOAnalizIlaveAciklamalari.JSProperties["cpErrorMessage"] = false;
                    }
                }
                catch
                {
        ...
        protected void GridViewTMOAnalizIlaveAciklamalari_CustomButtonCallback(object sender, ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            int index = e.VisibleIndex;
            int key = Convert.ToInt32(GridViewTMOAnalizIlaveAciklamalari.GetRowValues(index, new[] { "BorsaSubeKey" }));
            ASPxWebControl.RedirectOnCallback(string.Format("TMOAnalizIlaveAciklamalari.aspx?Key={0}", key));
        }
        ...
        private void SetInitials()
        {
            ...
            LabelBaslik.Text = "TMO ANALİZ İLAVE AÇIKLAMALARI";
        ...
        private void DataLoad()
        {
            using (var entity = new DBEntities())
            {
                ...
                GridViewTMOAnalizIlaveAciklamalari.DataSource = null;
                GridViewTMOAnalizIlaveAciklamalari.DataSource = entity.TT_BORSA_SUBE.AsNoTracking().Select(p => new
                {
                    p.BorsaSubeKey,
                    p.Kod,
                    p.BorsaSubeAdi,
                ...
                GridViewTMOAnalizIlaveAciklamalari.DataBind();
