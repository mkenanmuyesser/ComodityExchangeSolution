...
{
    public partial class TSELabParametreKayit : Page
    {
        #region Properties
        ...
        {
            Response.Redirect("TSELabParametreKayit.aspx");
        }
        ...
        private void SetInitials()
        {
            if (TuccarDepoKey == 0)
            {
                LabelBaslik.Text = "TSE LAB PARAMETRE KAYDET";
            ...
            {
                LabelBaslik.Text = "TSE LAB PARAMETRE GÜNCELLE";
