<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page/Main.master" AutoEventWireup="true" CodeBehind="TSELabParametreArama.aspx.cs" Inherits="TicaretBorsasi_Project.Program.SalonSatis.SatisIslemleri.TSELabParametreArama" %>
        ...
        <table style="border-color: #999999; width: 99.9%;" border="1">
            ...
            <tr>
                <td class="TdSol" style="width: 15%">
                    <dx:ASPxLabel runat="server" Text="Analiz Grup No : " Font-Size="Small" />
                </td>
                <td class="TdSag">
                    <dx:ASPxSpinEdit ID="SpinEditAnalizGrupNo" runat="server" DecimalPlaces="2" Width="200px" Font-Size="Small" MaxLength="6" NumberType="Integer" AllowNull="true" MinValue="0" SpinButtons-ShowIncrementButtons="false">
                    </dx:ASPxSpinEdit>
                </td>
                <td class="TdSol" style="width: 15%">
                    <dx:ASPxLabel runat="server" Text="Analiz Grup Adı : " Font-Size="Small" />
                </td>
                <td class="TdSag">
                    <dx:ASPxTextBox ID="TextBoxAnalizGrupAdi" runat="server" Width="200px" Font-Size="Small" MaxLength="100">
                    </dx:ASPxTextBox>
                </td>
            </tr>
            <tr>
                <td class="TdSol" style="width: 15%">
                    <dx:ASPxLabel runat="server" Text="Parametre No : " Font-Size="Small" />
                </td>
                <td class="TdSag">
                    <dx:ASPxSpinEdit ID="SpinEditParametreNo" runat="server" DecimalPlaces="2" Width="200px" Font-Size="Small" MaxLength="6" NumberType="Integer" AllowNull="true" MinValue="0" SpinButtons-ShowIncrementButtons="false">
                    </dx:ASPxSpinEdit>
                </td>
                <td class="TdSol" style="width: 15%">
                    <dx:ASPxLabel runat="server" Text="Parametre Adı : " Font-Size="Small" />
                </td>
                <td class="TdSag">
            ...
            <tr>
                <td class="TdOrtala" colspan="4">
                    <dx:ASPxGridViewExporter ExportedRowType="All" GridViewID="GridViewTSELabParametre" ID="GridViewExporterTSELabParametre" runat="server">
                    </dx:ASPxGridViewExporter>
                    <dx:ASPxGridView ID="GridViewTSELabParametre" ClientInstanceName="GridViewTSELabParametre" runat="server" KeyFieldName="TuccarDepoKey" AutoGenerateColumns="false" Width="100%" Font-Size="Small" OnRowDeleting="GridViewTSELabParametre_RowDeleting" OnCustomButtonCallback="GridViewTSELabParametre_CustomButtonCallback">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn FieldName="" Caption="Derece Adi">
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="" Caption="Derece Alt Limiti">
                                <CellStyle HorizontalAlign="Center" />
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataColumn>
