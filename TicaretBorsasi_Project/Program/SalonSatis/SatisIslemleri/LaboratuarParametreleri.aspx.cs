...
{
    public partial class LaboratuarParametreleri : Page
    {
        #region Properties
        ...
        protected void ButtonRapor_Click(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    GridViewExporterLaboratuarParametreleri.WriteXlsxToResponse("Laboratuar Parametreleri");
                    break;
                case 1:
                    GridViewExporterLaboratuarParametreleri.WritePdfToResponse("Laboratuar Parametreleri");
                    break;
                default:
                    break;
            }
        ...
        protected void ButtonKaydetGuncelle_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("LaboratuarParametreleri.aspx");
        }
        ...
        protected void GridViewLaboratuarParametreleri_RowDeleting(object sender, ASPxDataDeletingEventArgs e)
        {
            using (var entity = new DBEntities())
            {
                ...
                try
                {
                    if (Key != 0)
                    {
                        GridViewLaboratuarParametreleri.JSProperties["cpErrorMessage"] = true;
                    }
                    else
                    {
                        entity.SaveChanges();
                        GridViewLaboratuarParametreleri.JSProperties["cpErrorMessage"] = false;
                    }
                }
                catch
                {
        ...
        protected void GridViewLaboratuarParametreleri_CustomButtonCallback(object sender, ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            int index = e.VisibleIndex;
            int key = Convert.ToInt32(GridViewLaboratuarParametreleri.GetRowValues(index, new[] { "BorsaSubeKey" }));
            ASPxWebControl.RedirectOnCallback(string.Format("LaboratuarParametreleri.aspx?Key={0}", key));
        }
        ...
        private void SetInitials()
        {
            ...
            LabelBaslik.Text = "LABORATUAR PARAMETRELERİ";
        }
        ...
        private void DataLoad()
        {
            using (var entity = new DBEntities())
            {
                ...
                GridViewLaboratuarParametreleri.DataSource = null;
                GridViewLaboratuarParametreleri.DataSource = entity.TT_BORSA_SUBE.AsNoTracking().Select(p => new
                {
                    p.BorsaSubeKey,
                    p.Kod,
                    p.BorsaSubeAdi,
                ...
                GridViewLaboratuarParametreleri.DataBind();
