...
{
    public partial class UretimMerkezleri : Page
    {
        #region Properties
        ...
        protected void ButtonRapor_Click(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    GridViewExporterUretimMerkezleri.WriteXlsxToResponse("Üretim Merkezleri");
                    break;
                case 1:
                    GridViewExporterUretimMerkezleri.WritePdfToResponse("Üretim Merkezleri");
                    break;
                default:
                    break;
            }
        ...
        protected void ButtonKaydetGuncelle_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("UretimMerkezleri.aspx");
        }
        ...
        protected void GridViewUretimMerkezleri_RowDeleting(object sender, ASPxDataDeletingEventArgs e)
        {
            using (var entity = new DBEntities())
            {
                ...
                try
                {
                    if (Key != 0)
                    {
                        GridViewUretimMerkezleri.JSProperties["cpErrorMessage"] = true;
                    }
                    else
                    {
                        entity.SaveChanges();GridViewUretimMerkezleri.JSProperties["cpErrorMessage"] = false;
                    }
                }
                catch
                {
        ...
        protected void GridViewUretimMerkezleri_CustomButtonCallback(object sender, ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            int index = e.VisibleIndex;
            int key = Convert.ToInt32(GridViewUretimMerkezleri.GetRowValues(index, new[] { "BorsaSubeKey" }));
            ASPxWebControl.RedirectOnCallback(string.Format("UretimMerkezleri.aspx?Key={0}", key));
        }
        ...
        private void SetInitials()
        {
            ...
            LabelBaslik.Text = "ÜRETİM MERKEZLERİ";
        }
        ...
        private void DataLoad()
        {
            using (var entity = new DBEntities())
            {
                ...
                GridViewUretimMerkezleri.DataSource = null;
                GridViewUretimMerkezleri.DataSource = entity.TT_BORSA_SUBE.AsNoTracking().Select(p => new
                {
                    p.BorsaSubeKey,
                    p.Kod,
                    p.BorsaSubeAdi,
                ...
                GridViewUretimMerkezleri.DataBind();
