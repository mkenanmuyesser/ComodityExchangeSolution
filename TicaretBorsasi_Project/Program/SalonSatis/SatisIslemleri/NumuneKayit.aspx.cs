...
{
    public partial class NumuneKayit : Page
    {
        #region Properties
        ...
        {
            Response.Redirect("NumuneKayit.aspx");
        }
        ...
        private void SetInitials()
        {
            if (TuccarDepoKey == 0)
            {
                LabelBaslik.Text = "NUMUNE KAYDET";
            ...
            {
                LabelBaslik.Text = "NUMUNE GÜNCELLE";
            ...
            if (!IsPostBack)
            {
                DateEditGirisSaati.Value = DateTime.Now;                
